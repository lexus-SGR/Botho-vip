// commands/removebg.mjs
import fetch from "node-fetch";

export default {
  name: "😁removebg",
  description: "Ondoa background ya picha (Remove.bg)",
  category: "removebg",
  async execute(sock, msg) {
    ...
    await sock.sendMessage(msg.key.remoteJid, { image: imageBuffer, caption: "Background imeondolewa! 🔥" }, { quoted: msg });
  }
};
